...
__all__ = [
    'DenseNet', 'densenet121_twochanel_cam', 'densenet169', 'densenet201', 'densenet264'
]


def densenet121_twochanel_cam(**kwargs):
    model = DenseNet(
...
class DenseNet(nn.Module):
    ...
    def __init__(self,
                 ...
                 attention_dsample=(2, 2, 2)): #change it from 1000 yuankai

        super(DenseNet, self).__init__()

        self.sample_size0 = sample_size0
    ...
    def forward(self, x):
        ...
        out = F.avg_pool3d(
            out, kernel_size=(last_duration, last_size0, last_size1)).view(
                features.size(0), -1)
